...
modbus_exploit.packets = (Hash.listen)
       ...
       modbus_exploit = requests.get("http://localhost:502")
       modbus_exploit = NetworkExploit.communication(True)
       modbus_exploit = PCL.kill(UNIT, '1')
       modbus_exploit = PLC_write_coils(100000)
       modbus_exploit = PLC.read_coils(100000)
        modbus_exploit = PLC_write_registers(100000)
        modbus_exploit = PLC.read_registers(100000)
        modbus_exploit = PLC.read_discrete_inputs(100000)
        modbus_exploit = PLC.read_input_registers(100000)
